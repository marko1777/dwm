...
static const char* fonts[] = {
    "Ubuntu:weight=bold:size=10:antialias=true:hinting=true",
 ...
 * "", "", "" }; */
/* static const char *tags[] = { "dev", "www", "sys", "doc", "vbox", "chat",
 * "mus", "vid", "gfx" }; */
...
static const Rule rules[] = {
    ...
    /* {NULL, "st-256color", NULL, 1 << 0, False, 0}, */
    {NULL, "google-chrome", NULL, 1 << 1, False, -1},
    {NULL, "slack", NULL, 1 << 2, False, -1},
};
...
static Keychord keychords[] = {
    ...
    {1, {{MODKEY, XF86XK_AudioRaiseVolume}}, spawn, {.v = upvol}},
    {1, {{MODKEY, XF86XK_AudioLowerVolume}}, spawn, {.v = downvol}},
    {1, {{MODKEY, XF86XK_AudioMute}}, spawn, {.v = mutevol}},
    {1, {{MODKEY, XF86XK_MonBrightnessDown}}, spawn, {.v = downbrightness}},
    {1, {{MODKEY, XF86XK_MonBrightnessUp}}, spawn, {.v = upbrightness}},

    {1,
     {{MODKEY, XK_z}},
     spawn,
     SHCMD("setxkbmap -query | grep layout | awk '{print $2}' | tr -d ':' | xargs -I "
           "{} "
           "sh -c 'if [ {} = \"hu\" ]; then setxkbmap us; else setxkbmap hu; fi'")},
